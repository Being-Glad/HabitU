...
import { ArrowLeft, List, Palette, Archive, ArrowUpDown, Globe, Shield, Lock, Star, MessageSquare, ChevronRight, LogOut, User, Copy, HelpCircle, BookOpen } from 'lucide-react-native';
        ...
        <SafeAreaView style={[styles.container, { backgroundColor }]}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={[styles.section, { backgroundColor: cardColor }]}>
                    ...
                    {renderMenuItem(<Star color={accentColor} size={20} />, "Rate the app", handleRate)}
